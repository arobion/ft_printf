...
/*   Updated: 2017/12/15 00:00:16 by arobion          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_ntm_norminette(int **tab, char *str, t_norme i, int l)
{
...
void		norminette_jte_bz(t_norme *i, int *l)
{
	*l = 0;
	(*i).i = 0;
	(*i).j = 0;
...
int			ft_printf(const char *restrict format, ...)
{
	...
	va_end(ap);
	return (ft_ntm_norminette(tab, str, i, l));
}
