...
/*   Updated: 2017/12/14 19:31:01 by arobion          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

char					*ft_base_octal(unsigned long long int nb, t_param param)
{
...
unsigned long long int	var_modifier_o(unsigned long long int var, \
		t_param param)
{
...
char					*ft_flags_o(char *str, unsigned long long int var, \
		t_param param)
{
	int		i;
	char	*tmp;
