...
/*   Updated: 2017/12/14 23:39:35 by arobion          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void					ft_flags_x2(char *str, unsigned long long int var, \
		t_param param, int i)
{
...
char					*ft_flags_x(char *str, unsigned long long int var, \
		t_param param)
{
	int		i;
	char	*tmp;
	...
	if (!(ft_strcpy_p(str, tmp)))
		return (NULL);
	free(tmp);
	ft_flags_x2(str, var, param, i);
	return (str);
}

unsigned long long int	var_modifier_x(unsigned long long int var, \
		t_param param)
{
